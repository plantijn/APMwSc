...
Descripción: Defición de la clase clsLogin que contiene los métodos necesarios para
             solicitar el username y el password para el inicio de sesion del portal.
'''
